...
Question: Generate you’re question here

Choices: Write three distractor choice and one correct choice

Answer: select the correct answer and explain it in Chain of thought manners 
'''
    return CQAD_prompt
