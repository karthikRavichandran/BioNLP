...
clean_text_id = 2 # around 600 we have
for clean_text_id in range(2, 100):
    ...
    with open(f"../gen_files/clean_text/Clean_text_{clean_text_id}_version2.json", "w") as outfile:
